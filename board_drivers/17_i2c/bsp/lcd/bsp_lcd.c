...
{ 
	...
	if(x0 < 0) x0 = 0;
	if(y0 < 0) y0 = 0;
	if(x1 >= lcd_info.width) x1 = lcd_info.width - 1;
	if(y1 >= lcd_info.height) y1 = lcd_info.height - 1;
